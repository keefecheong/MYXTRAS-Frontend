<template>
    <div class="form-overlay">
        <LoadingOverlay
            ...
            :center="true"
            v-if="isSubmitting || (editMode && !isDataInitialized)"
        />
        ...
        <form class="form-overlay-content" @submit.prevent="submitForm">
            ...
            <div id="upload-image-container">
                ...
                <!-- display errors -->
                <div
                    id="upload-image-errors"
                    v-if="files.length > 0 && errors.length > 0"
                >
                ...
                >
                    ...
                    <ul>
                        <li
                            ...
                            :class="{
                                invalidFile: invalidFiles.includes(index),
                            }"
                        >
                ...
                <div v-if="selectedLinks.length > 0 && errors.length == 0">
                    ...
                    >
                        ...
                        <span class="hide-overflow-text">{{
                            this.editMode && !this.fileUpdated
                                ? blog.original_names[index]
                                : files[index].name
                        }}</span>
                        <!-- show size only if new files are uploaded -->
                        <span v-if="files[index]"
                            >({{ calculateSize(files[index].size) }})</span
                        >
                    </div>
                </div>
            </div>
            ...
            <div class="image-options-container">
                ...
                <div id="image-tags-selection">
                    <AddInterestButton
                        :selectedOption="tags"
                        @selectedInterests="handlePostTags"
                    >
            ...
            <div class="image-options-container">
                <span id="comments-title" class="image-options-label"
                    >Turn on comments:</span
                >
            ...
            <div id="image-form-controls">
                ...
                <input
                    ...
                    :disabled="
                        ...
                        (editMode && !fieldsChanged && !fileUpdated) ||
                        submitting
                    "
                />
            </div>
...
#image-caption,
#image-location,
#image-tags-selection,
#image-comments-options {
    width: 100%;
}
