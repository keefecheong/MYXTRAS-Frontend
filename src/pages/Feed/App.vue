        ...
        <div id="main-content">
            <div class="row pink-header-search">
                ...
                <div class="col-md-3 d-flex justify-content-end">
                    ...
                    <p class="school"></p>
                    <img v-if="loggedin" class="headerprofilepic" src="https://www.vhv.rs/dpng/d/439-4393951_random-picture-of-a-person-hd-png-download.png">
                        ...
                        <div class="row">
                            <p>
                                <div style="text-align:center">
                                    ...
                                    <span class="dot1" @click="currentSlide(3, 0)"></span>
                                </div>
                            </p>
                        </div>
                        <div class="row">
...
export default {
    ...
    methods: {
        ...
        showSlides(n, no) {
            let i;
            let slides = this.$el.getElementsByClassName(this.slideId[no]);
            let dots = this.$el.getElementsByClassName(this.dotId[no]);
