    ...
    <div id="main-container" class="center-main-container">
        ...
        <div class="form-container">
            <form @submit.prevent="loginUser">
                ...
                <input type="email" placeholder="Email Address" v-model="emailAddress" required>
                
                <div class="password-field-container">
                    <input :type="showPassword ? 'text' : 'password'" v-model="password" placeholder="Password" required>
                    <button type="button" class="material-symbols-outlined" id="show-password-button" :class="{ 'show-password': showPassword }" @click="hidePassword">visibility_off</button>
                </div>
                
                <div id="recaptcha-container"></div>
    
                <button type="submit" class="submit-button use-primary-secondary-gradient">
                    Log in
                </button>
            </form>
