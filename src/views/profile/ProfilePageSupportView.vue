        ...
        <AdminBanner>
            ...
            <template v-slot:right-content>
                <div class="banner-toggle-container">
                    ...
                    <button class="use-primary-secondary-gradient details-button hover-contrast" :class="{ 'active': !viewWarnings }" title="View submitted reports" @click="() => toggleWarnings(false)">Submitted Reports</button>
                </div>
            </template>
        </AdminBanner>
...
export default {
    ...
    methods: {
        ...
        async getReports() {
            ...
            await fetch(`${import.meta.env.VITE_APP_SERVER_URL}/api/report/user/submitted`, {
                mode: 'GET',
                credentials: 'include',
                mode: 'cors'
            }).then(async res => {
